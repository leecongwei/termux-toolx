            ...
            while True:
              ...
              for i in tool.names:
                if tool.category[int(cmd)-1] in tool.data[i]["category"]:
                  ...
                  print(f" \033[01;32m[ \033[00m{cnt} \033[01;32m] \033[01;33minstall \033[01;32m{too
l.data[i]['name']}\033[00m")
                  cnt+=1
              print("")
              logo.back()
              ...
              if tcmd=="00" or tcmd=="back":
                ...
                try:
                  ...
                  if int(tcmd) in range(1,int(cat_total)+1):
                    ...
                    print(f"\007\033[01;31mSorry \033[01;37m: '{tcmd}' \033[01;31minvalid input !!\03
3[00m")
                    sleep(1)
                except ValueError:
